                    ...
                    <div class="flex">
                        ...
                        <div class="w-2/3 space-y-2">
                            <label class="block w-2/3">
                                ...
                                <input name="name" class="form-input mt-1 block w-full @error('name') border-red-500 @enderror" placeholder="Jane Doe">
                            ...
                            <label class="block w-full">
                                ...
                                <textarea name="content" class="form-textarea mt-1 block w-full @error('content') border-red-500 @enderror" rows="3" placeholder="Enter some long form content."></textarea>
