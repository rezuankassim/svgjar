<div class="min-h-screen bg-white w-64 shadow-lg text-gray-700">
    <div class="min-h-screen flex flex-col justify-between shadow-md px-6 py-4  space-y-16">
        <header>
            <a href="{{ route('dashboard') }}" class="flex items-center justify-center space-x-4 text-indigo-600">
        ...
        <main class="flex-1">
            <ul class="flex flex-col space-y-8">
                <li>
                    <x-layouts.sidebar-link :link="route('dashboard')" :active="request()->routeIs('dashboard')">
                        <x-slot name="icon">
                ...
                <li>
                    <x-layouts.sidebar-link :link="route('icons.index')" :active="request()->routeIs('icons.*')">
                        <x-slot name="icon">
